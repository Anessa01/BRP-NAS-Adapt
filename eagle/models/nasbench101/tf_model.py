...
def max_pool_3x3(net, unused_channels, data_format, data_type):
...
_opindex_to_ctor = {
    ...
    '4': lambda *a: max_pool_3x3(*a),
    '9': lambda *a: eltwise_add(*a)
}


def build_ops(input_size=(1,32,32,3), stacks_count=3, cells_count=3, num_classes=10, data_format='channels_last', data_type='float32'):
